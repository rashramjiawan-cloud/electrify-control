...
import { HardDrive, Upload, FileText, Clock, CheckCircle2, XCircle, Loader2, AlertTriangle } from 'lucide-react';
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <p className="text-sm text-muted-foreground">
              {updates?.length || 0} firmware/diagnostics acties
            </p>
          </div>
        ...
        {isLoading ? (
          ...
          <div className="rounded-xl border border-dashed border-border bg-card p-12 text-center">
            ...
            <p className="text-xs text-muted-foreground mt-1">Stuur een firmware update naar een laadpaal om te beginnen</p>
          </div>
        ) : (
      ...
      <Dialog open={fwDialogOpen} onOpenChange={setFwDialogOpen}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>Stuur een firmware update naar een laadpaal via OCPP UpdateFirmware</DialogDescription>
          </DialogHeader>
