...
import { Database, HardDrive, ShieldAlert, FileText, Zap, Heart } from 'lucide-react';
          ...
          <>
            ...
            <div className="mt-4 pt-3 border-t border-border">
              <p className="text-xs text-muted-foreground">
                Retentieperiodes: Meterdata <span className="font-mono">{meterDays}d</span> · Alerts <span className="font-mono">{alertDays}d</span> · Audit <span className="font-mono">{auditDays}d</span>
              </p>
            </div>
          </>
        )}
